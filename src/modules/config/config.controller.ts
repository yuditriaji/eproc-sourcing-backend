...
export class ConfigControllerBasis {
  ...
  @Post('basis')
  @ApiOperation({ summary: 'Create/Update tenant basis config and optional process config' })
  ...
  @Post('org-units/bulk')
  @ApiOperation({ summary: 'Bulk create OrgUnits from JSON (e.g., { ccs: [{ code, pgs }] })' })
